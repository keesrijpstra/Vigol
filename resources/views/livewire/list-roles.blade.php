...
<div class="px-4 sm:px-6 lg:px-8">
                    ...
                    <tbody class="divide-y divide-gray-200">
                            ...
                            <tr>
                                <td class="py-4 pr-3 pl-4 text-sm font-medium whitespace-nowrap text-gray-900 sm:pl-0">
                                    {{ $role->name }}</td>
                                <td class="px-3 py-4 text-sm whitespace-nowrap text-gray-500">{{ $role->title }}</td>
                                <td class="px-3 py-4 text-sm whitespace-nowrap text-gray-500">{{ $role->email }}</td>
                                <td class="px-3 py-4 text-sm whitespace-nowrap text-gray-500">{{ $role->role }}</td>
                                <td
    ...
    @if ($showSlideOver)
        @livewire('slide-over.slide-over')
    @endif
</div>
