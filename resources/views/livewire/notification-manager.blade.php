        ...
        <div 
            ...
            x-data="{ 
                ...
                init() {
                    ...
                    setTimeout(() => { 
                        this.show = false;
                        // After the transition completes, remove the notification
                        setTimeout(() => {
            ...
            <div class="p-4">
                <div class="flex items-start">
                    <div class="shrink-0">
                        ...
                        <svg class="size-6 text-yellow-400" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z" />
                        </svg>
                        @elseif($notification['type'] === 'error')
                        <svg class="size-6 text-red-400" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
